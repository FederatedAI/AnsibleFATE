...
- [2.4 基本概念与原理](#24-基本概念与原理)
    ...
    - [2.4.2 部署流程](#242-部署流程)
    - [2.4.3 部署形态](#243-部署形态)
    - [2.4.4 部署角色（fate）](#244-部署角色fate)
    - [2.4.5 部署模块（fate）](#245-部署模块fate)
    - [2.4.6 部署支持polling(fate)](#246-部署支持pollingfate)
    - [2.4.7 路由支持(fate)](#247-路由支持fate)
        - [2.4.7.1 配置路由的参数](#2471-配置路由的参数)
        - [**2.4.7.2 路由逻辑**](#2472-路由逻辑)
        - [2.4.7.3 路由地址](#2473-路由地址)
    - [2.4.8 证书支持(fate)](#248-证书支持fate)
    - [2.4.9 支持配置Spark参数（fate）](#249-支持配置spark参数fate)
