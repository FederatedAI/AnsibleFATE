...
def_check_setup() {
  local cnames=( "modules" "ssl_roles" "host_ips" "host_special_routes" "guest_ips" "guest_special_routes" "exchange_ips" "exchange_special_routes" )
  for cname in ${cnames[*]};
  do
...
def_assist_mode() {
  ...
  do
	...
	last_check_arg=$arg
      ...
      *)
	echo "arg: $arg wrong"
        echo "Usage: deploy.sh init -h|-g|-e|-m|-k"
      ;;
    esac
  done
